...
- Auto-triage agent: sweep new inquiries, draft a follow-up when information is missing, draft a proposal when it is complete. Both land for human review, neither sends itself.
