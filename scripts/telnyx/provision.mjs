...
const TOOL_SPECS = {
  ...
  create_inquiry: {
    description: 'Create a new group inquiry from a phone conversation. Use this when a caller asks about a group booking and no inquiry exists yet.',
    params: {
      company_name: S('Company or organisation name.', true),
      contact_name: S('Who is calling.', true),
      ...
      contact_email: S('Email, only if the caller volunteers one.'),
