...
export const MOCK_TOOL_INVOCATIONS: Record<string, ToolInvocationRow[]> = {
  'ses-2001': [
    ...
    { id: 't-2', session_id: 'ses-2001', tool: 'identify_guest', args_masked: { phone: '+*******2244' }, result_summary: 'GST-2244 Marcus Doyle, Silver', grounded: true, latency_ms: 88, created_at: ago(188) },
  ...
  'ses-2002': [
    ...
    { id: 't-21', session_id: 'ses-2002', tool: 'get_reservation', args_masked: { reservation_id: 'RES-8841' }, result_summary: 'SOL-CHI, Standard King, card on file', grounded: true, latency_ms: 74, created_at: ago(78) },
  ...
  'ses-2003': [
    ...
    { id: 't-41', session_id: 'ses-2003', tool: 'identify_guest', args_masked: { phone: '+*******8890' }, result_summary: 'no match on caller ID', grounded: false, latency_ms: 91, created_at: ago(20) },
...
export const MOCK_INQUIRIES: InquiryRow[] = [
  {
    ...
    payload: {
      ...
      contact_email: 'b***@harlowvance.com',
      contact_phone: '***-***-2211',
  ...
  },
  {
    ...
    payload: {
      ...
      contact_email: 'a***@camelbackfitness.com',
      contact_phone: '***-***-2211',
      event_type: 'Corporate Retreat',
      preferred_property_code: 'SOL-PHX',
      property_name: 'Solstice Phoenix Camelback',
  ...
  },
  {
    ...
    payload: {
      ...
      contact_email: 'm***@ridgelinesports.org',
      contact_phone: '***-***-2244',
  ...
  },
  {
    ...
    payload: {
      ...
      contact_email: 'n***@buckeyevalleyschools.org',
      contact_phone: '***-***-2288',
  ...
  },
  {
    ...
    payload: {
      ...
      contact_email: 'j***@meridianwp.com',
      contact_phone: null,
      event_type: 'Corporate Retreat',
  ...
  },
  {
    ...
    payload: {
      ...
      contact_email: 's***@blueanchorevents.com',
      contact_phone: '***-***-2233',
...
export const MOCK_PROPOSALS: Record<string, ProposalRow> = {
  ...
  'inq-2006': {
    ...
    sent_via: 'email',
    sent_to: 's***@blueanchorevents.com',
    sent_at: ago(23000),
